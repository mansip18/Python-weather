...
month = Label(root, text=today.strftime("%Y-%m-%d"), bg='white', font=("bold", 15))
...
def city_name():
	...
	api_request = requests.get("https://api.openweathermap.org/data/2.5/weather?q="
							+ city_entry.get() + "&units=metric&appid="+'f6eb6753e4e1b86c07ae6e1947532ab0')
